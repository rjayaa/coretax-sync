...
//       {/* Content - Conditional rendering berdasarkan active tab */}
//       {activeTab === 'faktur' ? (
//         // Form Faktur Content dengan layout yang dioptimalkan
//         <div className="space-y-6">
//           {/* Form Faktur dan Detail containers dengan Flexbox */}
//           <div className="flex flex-wrap gap-4">
//             {/* Faktur Form - responsif dengan max-width untuk mencegah terlalu lebar */}
//             <div className="flex-1 min-w-[300px] w-[calc(60%-1rem)]">
//               <FakturForm 
//                 onSubmit={handleFakturSubmit} 
//                 initialData={currentFaktur || undefined}
//                 isEdit={!!currentFaktur}
...
//             {/* Detail Faktur Form - responsif dengan max-width */}
//             <div className="flex-1 min-w-[300px] w-[calc(40%-1rem)]">
//               {currentFaktur ? (
//                 <DetailFakturForm 
//                   key={currentFaktur.id}
//                   fakturId={currentFaktur.id} 
