...
//       // Add column filters
//       if (npwpFilter) params.append('npwp', npwpFilter);
//       if (namaFilter) params.append('nama', namaFilter);
//       if (kodeTransaksiFilter) params.append('kode', kodeTransaksiFilter);
//       if (nomorFakturFilter) params.append('nomor', nomorFakturFilter);
//       if (referensiFilter) params.append('referensi', referensiFilter);
...
//       if (bulanFilter !== null) {
//         params.append('bulan', bulanFilter.toString());
//       }
      
//       if (tahunFilter !== null) {
//         params.append('tahun', tahunFilter.toString());
//       }
...
//             <p className="text-gray-500 text-sm">Tidak ada faktur yang memenuhi kriteria filter.</p>
//             <button
//               onClick={resetFilters}
